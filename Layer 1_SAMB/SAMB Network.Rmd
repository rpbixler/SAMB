...
gvis<-toVisNetworkData(g1)
nodelist<-gvis$nodes
#gvis$edges$value<-gvis$edges$Strength #weights edges by strength of tie; visualiztion gets messy
visNetwork(sort(gvis$nodes),gvis$edges,main="All Connections with SA-MB Staff",width = "100%",height = "850px") %>%
...
visNetwork(sort(gvis_communicate$nodes),gvis_communicate$edges,main="SAMB Communication Connections",width = "100%",height = "850px") %>%
  visLayout(randomSeed = 123) %>%
  visEdges(smooth =T,
           arrows =list(to = list(enabled = TRUE, scaleFactor = .5)),
           color = list(color = "lightblue", highlight = "black"))  %>% #https://datastorm-open.github.io/visNetwork/edges.html
...
visNetwork(sort(gvis_coordinate$nodes),gvis_coordinate$edges,main="SAMB Coordination Connections",width = "100%",height = "850px") %>%
  visLayout(randomSeed = 123) %>%
  visEdges(smooth =T,
           arrows =list(to = list(enabled = TRUE, scaleFactor = .5)),
           color = list(color = "lightblue", highlight = "black"))  %>% #https://datastorm-open.github.io/visNetwork/edges.html
...
visNetwork(sort(gvis_collaboration$nodes),gvis_collaboration$edges,main="SAMB Collaboration Connections",width = "100%",height = "850px") %>%
  visLayout(randomSeed = 123) %>%
  visEdges(smooth =T,
           arrows =list(to = list(enabled = TRUE, scaleFactor = .5)),
           color = list(color = "lightblue", highlight = "black"))  %>% #https://datastorm-open.github.io/visNetwork/edges.html
...
visNetwork(sort(gvis_science$nodes),gvis_science$edges,main="Science Support Connections",width = "100%",height = "850px") %>%
  visLayout(randomSeed = 123) %>%
  visEdges(smooth =T,
           arrows =list(to = list(enabled = TRUE, scaleFactor = .5)),
           color = list(color = "lightblue", highlight = "black"))  %>% #https://datastorm-open.github.io/visNetwork/edges.html
