...
visNetwork(sort(gvis3$nodes),gvis3$edges,main="SAMB Connections to External Partners (Individuals)",width = "100%",height = "850px") %>%
...
visNetwork(sort(gvis3_communicate$nodes),gvis3_communicate$edges, main="SAMB + External Partner Communication Network (Individuals)",width = "100%",height = "850px") %>%
  visLayout(randomSeed = 123) %>%
  visEdges(smooth =T,
           arrows =list(to = list(enabled = TRUE, scaleFactor = .5)),
           color = list(color = "lightblue", highlight = "black"))  %>% #https://datastorm-open.github.io/visNetwork/edges.html
...
visNetwork(sort(gvis3_coordinate$nodes),gvis3_coordinate$edges, main="SAMB + External Partner Coordination Network (Individuals)",width = "100%",height = "850px") %>%
  visLayout(randomSeed = 123) %>%
  visEdges(smooth =T,
           arrows =list(to = list(enabled = TRUE, scaleFactor = .5)),
           color = list(color = "lightblue", highlight = "black"))  %>% #https://datastorm-open.github.io/visNetwork/edges.html
...
visNetwork(sort(gvis3_collaborate$nodes),gvis3_collaborate$edges, main="SAMB + External Partner Collaboration Network (Individuals)",width = "100%",height = "850px") %>%
 visLayout(randomSeed = 123) %>%
  visEdges(smooth =T,
           arrows =list(to = list(enabled = TRUE, scaleFactor = .5)),
           color = list(color = "lightblue", highlight = "black"))  %>% #https://datastorm-open.github.io/visNetwork/edges.html
...
visNetwork(sort(gvis3_landscape$nodes),gvis3_landscape$edges,main="Landscape Conservation Connections with External Partners (Individuals",width = "100%",height = "850px") %>%
  visLayout(randomSeed = 123) %>%
  visEdges(smooth =T,
           arrows =list(to = list(enabled = TRUE, scaleFactor = .5)),
           color = list(color = "lightblue", highlight = "black"))  %>% #https://datastorm-open.github.io/visNetwork/edges.html
...
visNetwork(sort(gvis3_science$nodes),gvis3_science$edges,main="Science Support Connections with External Partners (Individuals",width = "100%",height = "850px") %>%
  visLayout(randomSeed = 123) %>%
  visEdges(smooth =T,
           arrows =list(to = list(enabled = TRUE, scaleFactor = .5)),
           color = list(color = "lightblue", highlight = "black"))  %>% #https://datastorm-open.github.io/visNetwork/edges.html
...
visNetwork(sort(gvis3_permit$nodes),gvis3_permit$edges,main="Permitting Connections with External Partners (Individuals",width = "100%",height = "850px") %>%
  visLayout(randomSeed = 123) %>%
  visEdges(smooth =T,
           arrows =list(to = list(enabled = TRUE, scaleFactor = .5)),
           color = list(color = "lightblue", highlight = "black"))  %>% #https://datastorm-open.github.io/visNetwork/edges.html
...
visNetwork(sort(gvis4$nodes),gvis4$edges,main="SAMB Connections to External Partners (Organizations)",width = "100%",height = "850px") %>%
 visLayout(randomSeed = 123) %>%
  visEdges(smooth =T,
           arrows =list(to = list(enabled = TRUE, scaleFactor = .5)),
           color = list(color = "lightblue", highlight = "black"))  %>% #https://datastorm-open.github.io/visNetwork/edges.html
