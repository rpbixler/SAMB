...
visNetwork(nodes,edges,main="All Connections",width = "100%",height = "850px") %>%
...
#anonymizing
nodes <- sort(gvis2_communicate$nodes)
edges <- gvis2_communicate$edges
...
visNetwork(nodes,edges, main="SAMB + USFWS Communication Connections",width = "100%",height = "850px") %>%
  visLayout(randomSeed = 123) %>%
  visEdges(smooth =T,
           arrows =list(to = list(enabled = TRUE, scaleFactor = .5)),
           color = list(color = "lightblue", highlight = "black"))  %>% #https://datastorm-open.github.io/visNetwork/edges.html
...
#anonymizing
nodes <- sort(gvis2_coordinate$nodes)
edges <- gvis2_coordinate$edges
...
visNetwork(nodes,edges, main="SAMB + USFWS Coordination Connections",width = "100%",height = "850px") %>%
  visLayout(randomSeed = 123) %>%
  visEdges(smooth =T,
           arrows =list(to = list(enabled = TRUE, scaleFactor = .5)),
           color = list(color = "lightblue", highlight = "black"))  %>% #https://datastorm-open.github.io/visNetwork/edges.html
...
#anonymizing
nodes <- sort(gvis2_collaboration$nodes)
edges <- gvis2_collaboration$edges
...
visNetwork(nodes,edges, main="SAMB + USFWS Collaboration Connections",width = "100%",height = "850px") %>%
  visLayout(randomSeed = 123) %>%
  visEdges(smooth =T,
           arrows =list(to = list(enabled = TRUE, scaleFactor = .5)),
           color = list(color = "lightblue", highlight = "black"))  %>% #https://datastorm-open.github.io/visNetwork/edges.html
...
```{r, echo=FALSE, warning=FALSE}
saveWidget(fig,
            "SAMB_USFWS_Network_anonymized.html",
            selfcontained = T,
            libdir = "lib3")
...
#anonymizing
nodes <- sort(gvis2_landscape$nodes)
edges <- gvis2_landscape$edges
...
#anonymizing
nodes <- sort(gvis2_science$nodes)
edges <- gvis2_science$edges
...
#anonymizing
nodes <- sort(gvis2_permit$nodes)
edges <- gvis2_permit$edges
...
#anonymizing
nodes <- sort(gvis2_BA$nodes)
edges <- gvis2_BA$edges
